  ...
  return (
    <div className='min-h-screen bg-[#f3f3f3] flex flex-col'>
      ...
      <div className='flex-1 px-6 py-20'>
        ...
        {/* Feature Cards */}
        <div className='flex flex-wrap md:flex-row justify-center items-end gap-12 mt-24 mb-28'>
          {
            [
              {
                icon: <BsRobot size={24}/>,
                step: "STEP 1",
                title: "Select Role & Interview Type",
                desc: "Choose from a wide range of roles and interview formats tailored to your needs."
              },
              {
                icon: <BsMic size={24}/>,
                step: "STEP 2",
              ...
              <motion.div
                ...
                p-10 w-80 max-w-[90%] shadow-[0_10px_40px_rgba(0,0,0,0.08)] hover:shadow-2xl
