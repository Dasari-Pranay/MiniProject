...
const Pricing = () => {
  ...
  return (
    <div className='min-h-screen bg-linear-to-br from gray-50 to-emerald-50 py-16 px-6'>
      ...
      <div className='max-w-6xl mx:suto mb-14 flex items-start gap-4'>
            ...
            >
              ...
              <div className='mt-6 space-y-3 text-left'>
                ...
                {plan.features.map((feature, i) => (
                  ...
                  <div key={i} className='flex itemss-center gap-3'>
              ...
              {!plan.default && (
                ...
                <button
                  ...
                  className={`w-full mt-8 py-3 rounded-xl font-semibold tresition ${
                    isSelected
