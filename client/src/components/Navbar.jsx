      ...
      >
        ...
        <div className="flex items-center gap-6">
          ...
          <div ref={creditRef} className="relative">
            ...
            {showCreditPopup && (
              <div className="absolute right-0 top-12 w-64 bg-white shadow-xl border border-gray-200 rounded-lg p-5 z-50">
                ...
                <button
                  ...
                  className="w-full bg-black text-white py-2 rounded-lg text-sm hover:bg-gray-800 transition cursor-pointer"
                >
                  Buy More Credits
                </button>
              </div>
